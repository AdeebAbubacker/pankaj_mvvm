...
class ParentsEducationBottomSheet extends StatefulWidget {
  ...
  @override
  State<ParentsEducationBottomSheet> createState() =>
      _ParentsEducationBottomSheetState();
}

class _ParentsEducationBottomSheetState
    extends State<ParentsEducationBottomSheet> {
  late Box<ParentsEducationDB> parentsEducationBox;
                                ...
                                onTap: () {
                                  if (newDisplayedBanks.isNotEmpty &&
                                    ...
                                    final selectedBankObject =
                                        parentsEducationBox.values.firstWhere(
                                            (bank) =>
  ...
  void _updateDisplayedBanks(String searchTerm) {
    final List<String> updatedDisplayedBanks = parentsEducationBox.values
        .where((bank) =>
